...
COPY data/* /tmp/curricula/

# Load curriculum data
RUN $TDB2TDBLOADER --graph=http://w3id.org/openeduhub/curricula/curriculum_bayern/# /tmp/curricula/curriculum_bayern.ttl
# RUN $TDB2TDBLOADER --graph=http://w3id.org/openeduhub/curricula/curriculum_bb/# /tmp/curricula/curriculum_bb.ttl
RUN $TDB2TDBLOADER --graph=http://example.org/dummy_items /tmp/curricula/dummy_items.ttl
